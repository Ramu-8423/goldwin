...
// in barcode section
Route::get('/result_history/{status}/{user_id}',[ResultController::class,'result_history']);
...
Route::get('/all_claim_bet/{user_id}',[BetController::class,'all_claim_bet']);
Route::post('/report',[ReportController::class,'report']);
Route::get('/bet_pdf/{id}/{user_id}',[PdfController::class,'bet_pdf']);
Route::get('/status_pdf/{id}/{status}/{user_id}',[PdfController::class,'status_pdf']);


Route::post('/fetch', [BetController::class, 'fetch_data']);
Route::get('/test',[BetController::class,'test']);
Route::post('/point_details',[BetController::class,'point_details']);
