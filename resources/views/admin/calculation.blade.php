            ...
            <div class="heading1 margin_0">
                ...
                <form action="{{ route('admin.calculation') }}" method="GET">
                    <div class="container mt-5">
                        <div class="row">
                            <div class="col-sm-2  mb-b">
                                <select id="user-select" name="use_terminal_id" class="form-control select2 mb-b">
                                    @foreach($users as $admin)
                            ...
                            <div class="col-sm-2">
                                <select name="bet_status" id="status" class="form-control form-control-sm mb-3">
                ...
                <form action="{{ route('admin.calculation') }}" method="GET">
                    <div class="row ml-4">
                        ...
                        <div class="col-sm-3 align-items-center">
                            <div class="input-group-sm-4 d-flex">
